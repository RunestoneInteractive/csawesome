...
.. parsonsprob:: most-common-practice-alarmclock-mixed
   ...
   =====
            return "7:00";
   =====
         } else if ((day == 0 || day == 6 && (vacation == false)) || (day >= 1 && day <= 5 && (vacation == false))){
   =====
            return "10:00";
   =====
         } else {
...
.. parsonsprob:: most-common-practice-datefashion-mixed
   ...
   .. table::
      ...
      +----------------------------------------------------+-----------------+
   -----
   public class DateStylishness { #tag:0; depends:;
   =====
      public static int dateFashion(int you, int date) { #tag:1; depends:0;
   =====
         if (you <= 2 || date <= 2) { #tag:2; depends:1; 
   =====
            return 0; } #tag:3; depends:2;
   =====
         if (you >= 8 || date >= 8) { #tag:4; depends:1;
   =====
            return 2; } #tag:5; depends:4;
   =====
         return 1; } #tag:6; depends:3,5;
   =====
   } #tag:7; depends:6;
...
.. parsonsprob:: most-common-practice-frontback-mixed
   ...
   * Otherwise return ``"n"``.
   ...
   =====
         else if (beginWithStart && !endWithEnd) { #tag:5; depends:4;
   =====
            return "s";} #tag:6; depends:5;
   =====
         else if (!beginWithStart && endWithEnd) { #tag:7; depends:4;
   =====
            return "e";} #tag:8; depends:7;
   =====
         else { #tag:9; depends:8;
   =====
            return "n"; #tag:10; depends:9;
   =====
         } //end else statement #tag:11; depends:10;
   =====
      } //end method #tag:12; depends:11;
   =====
   } //end class #tag:13; depends:12;
